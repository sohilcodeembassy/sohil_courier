...
@push('plugin_js')
    <script src="{{ asset('/backend/assets/js/plugins/visualization/d3/d3.min.js') }}" type="text/javascript"></script>
    <script src="{{ asset('/backend/assets/js/plugins/visualization/d3/d3_tooltip.js') }}" type="text/javascript"></script>
    <script src="{{ asset('/backend/assets/js/plugins/forms/styling/switchery.min.js') }}" type="text/javascript"></script>
@endpush
@push('js')
    <script src="{{ asset('/backend/assets/js/pages/dashboard.js') }}" type="text/javascript"></script>
                                    ...
                                    <table class="table text-nowrap">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="media-left media-middle">
                                                        <a href="#"><img src="{{ asset('/backend/assets/images/brands/facebook.png') }}" class="img-circle img-xs" alt=""></a>
                                                    </div>
                                                    <div class="media-left">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="media-left media-middle">
                                                        <a href="#"><img src="{{ asset('/backend/assets/images/brands/youtube.png') }}" class="img-circle img-xs" alt=""></a>
                                                    </div>
                                                    <div class="media-left">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="media-left media-middle">
                                                        <a href="#"><img src="{{ asset('/backend/assets/images/brands/spotify.png') }}" class="img-circle img-xs" alt=""></a>
                                                    </div>
                                                    <div class="media-left">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="media-left media-middle">
                                                        <a href="#"><img src="{{ asset('/backend/assets/images/brands/twitter.png') }}" class="img-circle img-xs" alt=""></a>
                                                    </div>
                                                    <div class="media-left">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="media-left media-middle">
                                                        <a href="#"><img src="{{ asset('/backend/assets/images/brands/bing.png') }}" class="img-circle img-xs" alt=""></a>
                                                    </div>
                                                    <div class="media-left">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="media-left media-middle">
                                                        <a href="#"><img src="{{ asset('/backend/assets/images/brands/amazon.png') }}" class="img-circle img-xs" alt=""></a>
                                                    </div>
                                                    <div class="media-left">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="media-left media-middle">
                                                        <a href="#"><img src="{{ asset('/backend/assets/images/brands/dribbble.png') }}" class="img-circle img-xs" alt=""></a>
                                                    </div>
                                                    <div class="media-left">
                                    ...
                                    <table class="table text-nowrap">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="media-left media-middle">
                                                        <a href="#"><img src="{{ asset('/backend/assets/images/placeholder.jpg') }}" class="img-circle img-xs" alt=""></a>
                                                    </div>
                                            ...
                                            <ul class="media-list content-group">
                                                <li class="media stack-media-on-mobile">
                                                    <div class="media-left">
                                                        <div class="thumb">
                                                            <a href="#">
                                                                <img src="{{ asset('/backend/assets/images/placeholder.jpg') }}" class="img-responsive img-rounded media-preview" alt="">
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active fade in has-padding" id="messages-tue">
                                        <ul class="media-list">
                                            <li class="media">
                                                <div class="media-left">
                                                    <img src="{{ asset('/backend/assets/images/placeholder.jpg') }}" class="img-circle img-xs" alt="">
